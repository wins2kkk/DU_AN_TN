...
namespace Akila.FPSFramework
{
    ...
    public class CharacterInput : MonoBehaviour
    {
       ...
       // public bool toggleLean = false;
        ...
        public DeathPanelManager deathPanelManager; // Kéo Panel Manager vào trong Inspector
        ...
        protected void Update()
        {
            ...
            {
                moveInput = Vector2.zero; // Chặn di chuyển
                jumpInput = false;        // Chặn nhảy
            }
        ...
        public void OnPlayerDeath()
        {
            ...
            {
                isDead = true;
                controls.Player.Disable(); // Tắt input ngay lập tức
                Debug.Log("💀 Player đã chết! Input bị vô hiệu hóa.");
                //StartCoroutine(ShowDeathPanelAfterDelay(3f));
            }
        }
        ...
        //        //Debug.Log("🛑 Input đã bị tắt.");

        //        //// Tắt input
        //        //controls.Player.Disable();

        //        //// Chờ 4 giây rồi bật lại input
        //        //yield return new WaitForSeconds(4f);
        //        //controls.Player.Enable();
        //        //isDead = false;
        //        //Debug.Log("✅ Input đã bật lại sau 4s.");
        //    }
        //    else
        //    {
        //        Debug.LogError("❌ Không tìm thấy DeathPanelManager!");
        //    }
        //}
        ...
        private void OnDestroy()
        {
            ...
            {
                controls.Player.Disable();
                Debug.Log("🛑 Controls đã được Disable để tránh rò rỉ bộ nhớ.");
            }
        }
