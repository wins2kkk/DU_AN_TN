...
namespace Akila.FPSFramework
{
    ...
    public class HealthSystem_boss : MonoBehaviour, IDamageable
    {
        ...
        private void Update()
        {
            ...
            // Đặt trục X, Z về 0 để giữ nguyên trục Y
            fixedRotation.x = 0;
            fixedRotation.z = 0;

            // Cập nhật lại rotation
        ...
        private void LateUpdate()
        {
            ...
            {
                // Cập nhật vị trí (đặt phía trên đầu zombie)
                healthBar.transform.position = transform.position + new Vector3(0, 2f, 0);

                // Giữ Slider luôn hướng về camera
